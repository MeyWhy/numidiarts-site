...
function Hero() {
  return (
    <div className="relative h-screen bg-cover bg-center bg-no-repeat text-white" style={{ backgroundImage: "url('/background-hero.jpg')" }}>
    ...
    btn btn-xs sm:btn-sm md:btn-md lg:btn-lg xl:btn-lg
