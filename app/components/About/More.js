          ...
          <div className="stack stack-start w-48 sm:w-64 md:w-72 lg:w-80">
            <div className="border-base-content card bg-base-100 border text-center">
              <div className="card-body p-0">
                <img src="/images/hero.jpg" alt="Event 1" className="w-full h-full object-cover rounded-lg" />
              </div>
            </div>
            <div className="border-base-content card bg-base-100 border text-center">
              <div className="card-body p-0">
                <img src="/images/quisommesnous.jpg" alt="Event 2" className="w-full h-full object-cover rounded-lg" />
              </div>
            </div>
            <div className="border-base-content card bg-base-100 border text-center">
              <div className="card-body p-0">
                <img src="/images/hero.jpg" alt="Event 3" className="w-full h-full object-cover rounded-lg" />
              </div>
            </div>
          </div>
        </div>
