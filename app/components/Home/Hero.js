...
function Hero() {
  return (
    <div className="relative h-screen bg-cover bg-center bg-no-repeat text-white" style={{ backgroundImage:`url(${process.env.NEXT_PUBLIC_BASE_PATH || ''}/images/background-hero.jpg)` }}>
