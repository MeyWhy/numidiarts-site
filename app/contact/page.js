      ...
      <div className="w-full sm:w-4/5 md:w-2/3 lg:w-1/2 max-w-3xl bg-white shadow-lg rounded-2xl p-6 sm:p-8">
        ...
        <section className="space-y-6">
          <div>
            ...
            <p className="mt-1 text-gray-700 text-sm sm:text-base">+213 553 318 775 53</p>
          </div>
          ...
          <div>
            ...
            <p className="mt-1 text-gray-600 text-sm sm:text-base">numidiafounoun@gmail.com</p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-2 list-none space-y-2 text-gray-700">
              ...
              <li className="flex items-center gap-2">
                ...
                <a
                  href="https://instagram.com/numidi_arts"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:underline text-sm sm:text-base break-all"
                >
